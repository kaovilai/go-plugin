...
func (x *ConnInfo_Knock) Reset() {
	*x = ConnInfo_Knock{}
	if protoimpl.UnsafeEnabled {
		mi := &file_grpc_broker_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ConnInfo_Knock) Descriptor() ([]byte, []int) {
	return file_grpc_broker_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_grpc_broker_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
func file_grpc_broker_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_grpc_broker_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
